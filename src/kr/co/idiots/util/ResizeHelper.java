...
public class ResizeHelper {
    ...
    static class ResizeListener implements EventHandler<MouseEvent> {
        ...
        public void handle(MouseEvent mouseEvent) {
            ...
            double mouseEventX = mouseEvent.getSceneX() - 100, 
                   mouseEventY = mouseEvent.getSceneY() - 100,
                   sceneWidth = scene.getWidth() - 200,
                   sceneHeight = scene.getHeight() - 200;
            
            
            
            double delX = mouseEventX - lastX;
            double delY = mouseEventY - lastY;
                    ...
                    if (Cursor.W_RESIZE.equals(cursorEvent) == false && Cursor.E_RESIZE.equals(cursorEvent) == false) {
                        ...
                        if (Cursor.NW_RESIZE.equals(cursorEvent) == true || Cursor.N_RESIZE.equals(cursorEvent) == true || Cursor.NE_RESIZE.equals(cursorEvent) == true) {
                            if (stage.getHeight() > minHeight || mouseEventY < 0) {
                                stage.setHeight(stage.getY() - mouseEvent.getScreenY() + 100 + stage.getHeight());
                                stage.setY(mouseEvent.getScreenY() - 100);
                            }
                        } else {
                            if (stage.getHeight() > minHeight || mouseEventY + startY - stage.getHeight() > 0) {
                                stage.setHeight(mouseEventY + startY + 100);
                            }
                        }
                    }
                    ...
                    if (Cursor.N_RESIZE.equals(cursorEvent) == false && Cursor.S_RESIZE.equals(cursorEvent) == false) {
                        ...
                        if (Cursor.NW_RESIZE.equals(cursorEvent) == true || Cursor.W_RESIZE.equals(cursorEvent) == true || Cursor.SW_RESIZE.equals(cursorEvent) == true) {
                            if (stage.getWidth() > minWidth || mouseEventX < 0) {
                                stage.setWidth(stage.getX() - mouseEvent.getScreenX() + 100 + stage.getWidth());
                                stage.setX(mouseEvent.getScreenX() - 100);
                            }
                        } else {
                            if (stage.getWidth() > minWidth || mouseEventX + startX - stage.getWidth() > 0) {
                                stage.setWidth(mouseEventX + startX + 100);
                            }
                        }
                    }
                }
